          ...
          <div className="container">
            <div className="row">
              <div className="col-md-8 push-md-2">
                <h1 className='h3 text--light mt-4'>How to Do Mindful Meditation</h1>
                ...
                <h2 className='h5 text--light mt-5'>1. Select a location</h2>
                ...
                <h2 className='h5 text--light mt-5'>2. Get comfortable</h2>
                ...
                <h2 className='h5 text--light mt-5'>3. Set aside some time</h2>
                ...
                <h2 className='h5 text--light mt-5'>4. Find comfortable posture</h2>
                ...
                <h2 className='h5 text--light mt-5'>5. Settle your mind</h2>
                ...
                <h2 className='h5 text--light mt-5'>6. Take some deep breaths</h2>
                ...
                <h2 className='h5 text--light mt-5'>7. Focus on the present</h2>
                ...
                <h2 className='h5 text--light mt-5'>8. Realize that you are not your thoughts</h2>
