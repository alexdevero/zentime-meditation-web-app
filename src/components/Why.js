          ...
          <div className="container">
            <div className="row">
              <div className="col-md-8 push-md-2">
                <h1 className='h3 text--light mt-4'>13 Biggest benefits of meditation</h1>
                ...
                <h2 className="h5 text--light mt-5">1. Better Focus</h2>
                ...
                <h2 className="h5 text--light mt-5">2. More Creativity</h2>
                ...
                <h2 className='h5 text--light mt-5'>3. Increased Immunity</h2>
                ...
                <h2 className="h5 text--light mt-5">4. Better Memory</h2>
                ...
                <h2 className="h5 text--light mt-5">5.Less Stress</h2>
                ...
                <h2 className="h5 text--light mt-5">6. Less Anxiety</h2>
                ...
                <h2 className="h5 text--light mt-5">7. More Gray Matter</h2>
                ...
                <h2 className='h5 text--light mt-5'>8. Emotional Balance</h2>
                ...
                <h2 className='h5 text--light mt-5'>9. Increased Fertility</h2>
                ...
                <h2 className='h5 text--light mt-5'>10. Relieves Irritable Bowel Syndrome</h2>
                ...
                <h2 className='h5 text--light mt-5'>11. Lowers Blood Pressure</h2>
                ...
                <h2 className='h5 text--light mt-5'>12. Anti-Inflammatory</h2>
                ...
                <h2 className='h5 text--light mt-5'>13. Calmness</h2>
